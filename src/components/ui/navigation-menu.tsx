...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-auto w-max items-center justify-center rounded-md bg-none px-0 py-0 text-sm font-medium transition-colors focus:outline-none disabled:pointer-events-none disabled:opacity-50"
)
...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute left-0 lg:left-[45%]  lg:top-full top-[65%] flex justify-center")}>
